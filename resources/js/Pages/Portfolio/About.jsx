                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <div className="mt-8">
                                <Link href={route('contact')} className="bg-purple-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-purple-700 transition-colors">
                                    Let's Work Together
                                </Link>
                            </div>
                        </div>
                            ...
                            <div className="flex-grow">
                                <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                                    <div>
                                        ...
                                        <p className="text-purple-600 font-medium">Tech Solutions Inc.</p>
                                    </div>
                                    <span className="text-gray-500 text-sm md:text-base">2022 - Present</span>
                                </div>
                                ...
                                <div className="flex flex-wrap gap-2 mt-3">
                                    <span className="px-3 py-1 bg-white text-gray-700 text-sm rounded-full">Laravel</span>
                                    <span className="px-3 py-1 bg-white text-gray-700 text-sm rounded-full">React</span>
                                    <span className="px-3 py-1 bg-white text-gray-700 text-sm rounded-full">Team Leadership</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-6 p-6 bg-gray-50 rounded-2xl">
                            ...
                            <div className="flex-grow">
                                <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                                    ...
                                    <span className="text-gray-500 text-sm md:text-base">2020 - 2022</span>
                                </div>
                                <p className="text-gray-600 mt-3">
                                ...
                                <div className="flex flex-wrap gap-2 mt-3">
                                    <span className="px-3 py-1 bg-white text-gray-700 text-sm rounded-full">Vue.js</span>
                                    <span className="px-3 py-1 bg-white text-gray-700 text-sm rounded-full">PHP</span>
                                    <span className="px-3 py-1 bg-white text-gray-700 text-sm rounded-full">MySQL</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex-grow">
                                <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                                    <div>
                                        ...
                                        <p className="text-green-600 font-medium">StartUp Studios</p>
                                    </div>
                                    <span className="text-gray-500 text-sm md:text-base">2019 - 2020</span>
                                </div>
                                <p className="text-gray-600 mt-3">
                                ...
                                <div className="flex flex-wrap gap-2 mt-3">
                                    <span className="px-3 py-1 bg-white text-gray-700 text-sm rounded-full">JavaScript</span>
                                    <span className="px-3 py-1 bg-white text-gray-700 text-sm rounded-full">HTML/CSS</span>
                                    <span className="px-3 py-1 bg-white text-gray-700 text-sm rounded-full">Git</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-white p-8 rounded-2xl shadow-lg">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Bachelor of Computer Science</h3>
                            <p className="text-purple-600 font-medium mb-2">University of Technology</p>
                            <p className="text-gray-500 mb-4">2015 - 2019</p>
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-lg">
                            ...
                            <p className="text-blue-600 font-medium mb-2">Various Platforms</p>
                            <p className="text-gray-500 mb-4">2019 - Present</p>
