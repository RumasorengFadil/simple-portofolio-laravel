...
@section('content')
<!-- Hero Section -->
<section class="min-h-screen flex items-center justify-center gradient-bg text-white relative overflow-hidden">
    ...
    <div class="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="space-y-6" x-data="{ shown: false }" x-init="setTimeout(() => shown = true, 500)">
            ...
            <p x-show="shown" x-transition.delay.400ms.duration.800ms class="text-lg md:text-xl mb-12 text-gray-300 max-w-2xl mx-auto">
                I craft digital experiences that blend beautiful design with powerful functionality. 
                Passionate about creating solutions that make a difference.
            </p>
            <div x-show="shown" x-transition.delay.600ms.duration.800ms class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('projects') }}" class="bg-white text-purple-600 px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105">
                    View My Work
                </a>
                <a href="{{ route('contact') }}" class="border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-purple-600 transition-all duration-300 transform hover:scale-105">
                    Get In Touch
                </a>
            </div>
        </div>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-gray-900 mb-4">What I Do</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center p-8 bg-gray-50 rounded-2xl hover:shadow-lg transition-shadow duration-300">
                ...
                <div class="flex flex-wrap justify-center gap-2">
                    <span class="px-3 py-1 bg-purple-100 text-purple-700 text-sm rounded-full">React</span>
                    <span class="px-3 py-1 bg-purple-100 text-purple-700 text-sm rounded-full">Vue.js</span>
                    <span class="px-3 py-1 bg-purple-100 text-purple-700 text-sm rounded-full">Tailwind</span>
                </div>
            </div>
            ...
            <div class="text-center p-8 bg-gray-50 rounded-2xl hover:shadow-lg transition-shadow duration-300">
                ...
                <div class="flex flex-wrap justify-center gap-2">
                    ...
                    <span class="px-3 py-1 bg-blue-100 text-blue-700 text-sm rounded-full">Node.js</span>
                    <span class="px-3 py-1 bg-blue-100 text-blue-700 text-sm rounded-full">MySQL</span>
                </div>
            </div>
            ...
            <div class="text-center p-8 bg-gray-50 rounded-2xl hover:shadow-lg transition-shadow duration-300">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-4">DevOps & Deployment</h3>
                <p class="text-gray-600 mb-6">
                    Deploying applications with CI/CD pipelines, Docker, and cloud platforms for optimal performance.
                </p>
                <div class="flex flex-wrap justify-center gap-2">
                    <span class="px-3 py-1 bg-green-100 text-green-700 text-sm rounded-full">Docker</span>
                    <span class="px-3 py-1 bg-green-100 text-green-700 text-sm rounded-full">AWS</span>
                    <span class="px-3 py-1 bg-green-100 text-green-700 text-sm rounded-full">Git</span>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mt-12">
            <a href="{{ route('projects') }}" class="bg-purple-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-purple-700 transition-colors">
                View All Projects
            </a>
        </div>
    </div>
...
<section class="py-20 gradient-bg text-white">
    <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('contact') }}" class="bg-white text-purple-600 px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105">
                Start a Project
            </a>
            <a href="{{ route('resume') }}" class="border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-purple-600 transition-all duration-300 transform hover:scale-105">
                Download Resume
            </a>
        </div>
    </div>
